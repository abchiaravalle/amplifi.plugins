...
return array(
    ...
    'nuances' => array(
        ...
        'When English uses a neutral verb (impact, affect, influence, address) about an outcome the customer wants changed, state the direction explicitly in Chinese: 减少停机、提升产能、缩短周期、改善状态. Never write 影响 plus a benefit noun — it reads as damage or as no claim at all.',
