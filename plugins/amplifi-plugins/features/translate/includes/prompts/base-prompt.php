...
- Preserve SCOPE. "including A, B, C" is open-ended and must stay open-ended — do not convert it to a closed list. Do not narrow a broad term to one of its senses: "Aerospace" covers air AND space; "under pressure" is not only time pressure; "at scale" is not only mass production.
