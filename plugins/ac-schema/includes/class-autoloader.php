 ...
 *
 * Maps the namespace prefix `Amplifi\Schema\` onto `includes/`:
 *   - Sub-namespaces become lowercase directory names with underscores
 *     converted to hyphens (e.g. `Amplifi\Schema\Crypto\Secret_Store`
...
final class Autoloader {
	...
	private const PREFIX = 'Amplifi\\Schema\\';
	...
	public static function load( string $class_name ): void {
		...
		$base = AMPLIFI_SCHEMA_PATH . 'includes/';
